...
\experience{Research Assistant}{Carnegie Mellon University}{Dec 2023}{Present}{
    ...
    \achievement{
        Employing transfer learning techniques and \textbf{fine-tuning language
            models} for semantic understanding in paraphrasing.
    }
    \achievement{
...
\experience{Summer@EPFL Intern}{EPFL Lausanne}{Jun 2023}{Sep 2023}{
    \achievement{
        ...
        \href{https://www.serhanyilmaz.org/Project-Charisius/library/getting_started.html}{\color {blue}
            \textbf{\textit{Project Charisius}}}. A Project
        dedicated to creating robust, privacy-preserving Federated
        ML environments.
    }
    \achievement{
        Optimized gradient aggregation functions using
        \textbf{PyTorch and CUDA} to
        work up to \textbf{2200\% faster}.
    }
    \achievement{
        \textbf{Published the charisius library}, for accelerated
        Statistics and Federated ML applications, up to \textbf{96\% reduction}
        in the runtime.
    }
    \achievement{
...
\experience{Club Founder/President}{kAi Sabanci}{Mar 2023}{Present}{
    \achievement{
        \textbf{Founding and leading} kAi Sabanci, Sabanci University's AI club, attracting \textbf{600+ members with 80\% participation rate}. Got kAi to become the \textbf{founding member} of the
        \href{https://developer.nvidia.com/student-network}{
            \color {blue} \textbf{\textit{NVIDIA Student Network}}}.
    }
    \achievement{
        Organized workshops on \textbf{Gen AI, NLP, Machine Learning and
            Deep Learning} and served as a \textbf{voluntary TA}.}
    \achievement{
        Selected for the \textbf{NVIDIA Student Spotlight} series for outstanding perseverance, dedication and achievement.
    }
    \achievement{
        Developed and managed several key projects in collaboration with
        academic faculty including the \href{https://kaisabanci.com/}{
            \color {blue} \textbf{\textit{kAi Sabanci website}}},
        our  \href{https://kaisabanci.com/chatSU}{
            \color {blue} \textbf{\textit{RAG-enabled Chatbot
                    -ChatSU-}}}\, campus modeling
        using \href{https://kaisabanci.com/projects}{
            \color {blue} \textbf{\textit{NeRF for Omniverse}}} and \href{https://kaisabanci.com/projects}{
            \color {blue} \textbf{\textit{cat identification with Jetson Nano}}}.
    }
}{Istanbul, Turkey}
